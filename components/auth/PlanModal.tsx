    ...
    >
      <div className="max-h-[90vh] w-full max-w-[500px] overflow-y-auto rounded-[3px] bg-white shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
        ...
        <div className="px-7 pb-6 pt-7">
          <h2 id="plan-modal-title" className="font-condensed text-[clamp(1.4rem,2.5vw,2rem)] font-black uppercase tracking-[0.02em] leading-none text-mentoria-teal">
            Choose Your Plan
          </h2>
          ...
          <button
            ...
            className={`mb-2.5 w-full border-[1.5px] p-4 text-left transition-colors ${
              selected === 'monthly'
                ? 'border-mentoria-gold bg-[rgba(247,188,21,0.05)]'
                : 'border-[rgba(25,53,62,0.1)] hover:border-mentoria-teal'
            } rounded-[2px]`}
          >
            <div className="mb-1.5 flex items-center justify-between">
              <span className="font-sans text-[0.85rem] font-bold uppercase tracking-[0.14em] text-mentoria-teal">
                Monthly Plan
              </span>
            </div>
            <div className="font-condensed text-[1.6rem] font-black leading-none text-mentoria-teal">
          ...
          >
            <div className="mb-1.5 flex items-center justify-between gap-2">
              ...
              <span className="rounded-[2px] bg-mentoria-gold px-1.5 py-0.5 font-sans text-[0.64rem] font-bold uppercase tracking-[0.1em] text-mentoria-teal">
                Best Value — Save 20%
              </span>
            </div>
            <div className="font-condensed text-[1.6rem] font-black leading-none text-mentoria-teal">
          ...
          <div className="mt-4 flex gap-2">
            <button
              type="button"
              onClick={onClose}
              className="rounded-[2px] border-[1.5px] border-[rgba(25,53,62,0.12)] bg-mentoria-light px-4 py-3 font-sans text-[0.72rem] font-bold uppercase tracking-[0.12em] text-[rgba(25,53,62,0.5)] transition-colors hover:border-mentoria-teal hover:text-mentoria-teal"
            >
              Cancel
            </button>
            <button
              type="button"
              onClick={onConfirm}
              className="flex-1 rounded-md border-none bg-mentoria-gold py-3 font-sans text-[0.8rem] font-bold uppercase tracking-[0.14em] text-mentoria-teal transition-all duration-300 hover:scale-[1.01] hover:brightness-105"
            >
              Confirm Selection
            </button>
          </div>
