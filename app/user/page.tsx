...
export default async function UserPage() {
  ...
  console.log('USER PAGE session:', session?.user?.id, session?.user?.email);
  ...
  console.log('USER PAGE profile:', profile, 'error:', error);
    ...
    >
      ...
      <div className="cards-grid">
        <a href="/user/courses" className="action-card">
          ...
          <h3>Courses</h3><p>Access premium learning courses.</p>
        </a>
        <a href="/user/quizzes" className="action-card">
          ...
          <h3>Quizzes</h3><p>Test your knowledge with expert quizzes.</p>
        </a>
        <a href="/user/materials" className="action-card">
          ...
          <h3>Materials</h3><p>Download premium templates and guides.</p>
        </a>
        <a href="/user/sessions" className="action-card">
          ...
          <h3>Mentor Sessions</h3><p>Book sessions with your mentor.</p>
        </a>
      </div>
    </DashboardShell>
  );
