...
-- Mentor/admin visibility for listing member rows — must NOT subquery profiles inside a profiles
-- policy (Postgres: infinite recursion). Use SECURITY DEFINER like is_admin().
