...
LOGO_URL="https://rwqmvicsvkvfanblhocf.supabase.co/storage/v1/object/public/materials/mentoria-logo.PNG"
echo "Updating email templates with logo and rounded buttons..."
...
const LOGO_URL = 'https://rwqmvicsvkvfanblhocf.supabase.co/storage/v1/object/public/materials/mentoria-logo.PNG';
...
echo ""
echo "Changes:"
echo "  ✓ Real Mentoria logo in header"
echo "  ✓ All buttons rounded to 30px"
echo "  ✓ Info boxes rounded to 12px"
echo "  ✓ Card border-radius 12px"
echo "  ✓ Gold #F7BC15 background"
echo "  ✓ Teal #19353E header/footer"
echo "  ✓ Light #EFEFEF tables"
echo ""
